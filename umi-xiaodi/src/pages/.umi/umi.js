...
import findRoute, {
  getUrlQuery,
} from 'C:/Users/Owen/node_modules/umi/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../../../../node_modules/umi/node_modules/umi-plugin-ui/lib/bubble').default(
      {
        port: 3000,
        path: 'C:/Users/Owen/Desktop/React Project/umi-xiaodi',
        currentProject: '',
        isBigfish: undefined,
      },
    );
...
(() => {
  ...
  window.GUmiUIFlag = require('../../../../../../node_modules/umi/node_modules/umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
